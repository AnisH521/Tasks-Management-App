...
import { deleteUser, getAllEndUsers, getAllSIC, getUserById, loginUser, logoutUser, registerUser } from '../controllers/user.controller.js';
...
userRouter.route("/register")
    .post(protectedRoute, isAdminRoute,registerUser)
